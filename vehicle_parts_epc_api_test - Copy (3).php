...
echo "<td>
<a href='pos_invoice_add_v2.php?part=".urlencode($row['part_name'])."&stock=".$stock."'
style='background:#cc0000;color:#fff;padding:4px 8px;text-decoration:none;border-radius:4px;font-weight:bold'>
Sell
</a>
</td>";
...
echo "<tr>";
echo "<td colspan='5' style='text-align:center;padding:15px'>";
