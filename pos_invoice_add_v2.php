...
if(e.data.type==="CUSTOMER_SELECTED"){
...
document.getElementById("item_search").value=part.part_name;
...
document.getElementById("item_search").value=part.description;
document.getElementById("item_price").value=part.selling_price;
});
}
...
SELECTED_ITEM=it;
document.getElementById("item_search").value=it.name;
document.getElementById("item_price").value=parseFloat(it.price||0).toFixed(2);
searchResults.style.display="none";
}
...
onclick="window.open('customer_add.php?return=invoice','NewCustomer','width=900,height=700')">
+ Add new customer "${q}"
</div>`;
...
document.getElementById("customer_id_number").value=c.id_number||"";
...
let qty=parseFloat(document.getElementById("item_qty").value);
